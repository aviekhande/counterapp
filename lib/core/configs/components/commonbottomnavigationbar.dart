...
void _onItemTapped(int index) {
  ...
  Widget build(BuildContext context) {
    return  BottomNavigationBar(
        ...
        selectedIconTheme: IconThemeData(size: 30.0), // Increased size for selected icon
        unselectedIconTheme: IconThemeData(size: 24.0), // Default size for unselected icons
        onTap: (index) {
          if (index == 3) {
